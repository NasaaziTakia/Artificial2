...
def best_first_search_tree(adj_list, heuristic, start, goal):
...
# Perform Best-First Search (Tree Search)
result = best_first_search_tree(adj_list, heuristic, start_node, goal_node)
